...
import GoodThingImage from '../../components/landing-good-thing/GoodThingImage'
  ...
  render() {
    return (
      ...
      >
        ...
        <TestimonialCarousel/>
        <Box>
          <Box direction='column' align='center' justify='center' margin={{top: 'medium'}}>
